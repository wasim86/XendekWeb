...
function Hero() {
  ...
  return (
    <section className="hero bg-[#fefbf3]">
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center px-4 md:px-0 py-16," style={{ minHeight: '600px', marginTop: '65px'   }}>
        ...
        <div className="relative w-full md:w-1/2 flex flex-col justify-center z-10 ">
          ...
          <p className="mb-6 text-lg md:text-xl">
            Design and develop conversion oriented websites for your business with Xendekweb.
          </p>
        ...
        <div className="relative w-full md:w-1/2 flex justify-center md:justify-end mb-8 md:mb-0 overflow-hidden, style={height: '550px'}">
          <img
            src={Banner}
            alt="Banner"
            className=""
